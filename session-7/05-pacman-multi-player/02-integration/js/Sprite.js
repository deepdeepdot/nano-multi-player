...
function Sprite(x, y, dx, dy, radius, color) {
  ...
  this.getArea = function() {
    throw new Error("Need to define getArea() " + this.constructor.name);
  }
  ...
  this.overlaps = function(otherSprite) {
      // return true;
    return isInside(this.getArea(), { x: otherSprite.x, y: otherSprite.y} ) 
        || isInside(otherSprite.getArea(), {x : this.x, y: this.y } );    
